...
public class Grafo {
	...
	public void printShortestPath(int origin, int destination) {
		/*
		 * Método imprime todos os vértices percorrigos, seguidos por seus
		 * custos.
		 */
	...
	private ArrayList<Vortex> searchShortestPath(int originValue, int destinationValue) {
		/*
		 * Método apenas chama o próximo que realmente vai procurar o menor
		 * caminho
		 */
	...
	private ArrayList<Vortex> searchShortestPath(Vortex vortex1, Vortex destination, ArrayList<Vortex> mainVortices) {
		/*
		 * Método vai percorrendo todos os sucessores dos vértices e para ao
		 * achar o destino. Ao achar o destino, continua a procurar nos demais
		 * sucessores, afim de ter certeza que o caminho encontrado é de fato o
		 * menor.
		 */
	...
	private int countCost(ArrayList<Vortex> vortices) {
		/*
		 * Retorna soma total dos custos que contém no array list. Caso o array
		 * list seja nulo, retorna Integer.MAX_VALUE.
		 */
		if (vortices != null) {
			int count = 0;
			Vortex prev = vortices.get(0);
	...
	private Vortex get(int value, Vortex vortex) {
		/*
		 * Retorna o vértice de acordo com seu valor. Se não existir, retorna
		 * null.
		 */
